...
* [keepalived 工作原理](#keepalived-工作原理)
    ...
    * [ARP 查询处理](#arp-查询处理)
    * [虚拟 IP 地址和 MAC 地址](#虚拟-ip-地址和-mac-地址)
    * [keepalived 进程](#keepalived-进程)
    * [keepalived 健康检查方式](#keepalived-健康检查方式)
* [keepalived 场景应用](#keepalived-场景应用)
    * [keepalived 主从切换](#keepalived-主从切换)
    * [keepalived 仅做 HA 时的配置](#keepalived-仅做-ha-时的配置)
* [其他配置](#其他配置)
    * [重定向 keepalived 输出日志](#重定向-keepalived-输出日志)
